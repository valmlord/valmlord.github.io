...
$(".product-card__nav-thumbnails .slick-slide").removeClass("slick-active"); // Set active class to first thumbnail slides

$(".product-card__nav-thumbnails .slick-slide").eq(0).addClass("slick-active"); // On before slide change match active thumbnail to current slide

$(".product-card__slider").on("beforeChange", function (event, slick, currentSlide, nextSlide) {
...
var getList = document.querySelectorAll('.side-btn');
...
function showList() {
  var getHide = document.querySelector('.accordion-catalog__sublist-hide');
  console.log(getHide);
